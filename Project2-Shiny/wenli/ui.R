                   ...
                   tabPanel('Storms on Time Series',
                            fluidRow(
                              ...
                              column(3,
                                     ...
                                     br('- The trend of storms: the peek, the pattern, inference for future.'),
                   ...
                   tabPanel('Fatality',
                            fluidRow(
                              ...
                              column(4,
                                     ...
                                     br(),
                                     h4('Graphs show...'),
                                     br('- More dangerous locations during storms'),
                                     br('- Gender comparison in each location'),
                                     br('- The age range of each gender for deaths in storms'),
                                     br(),
                                     br(),
                                     plotOutput('boxplt2', height = 180, width = 270)),
                              column(1))
                            ),
