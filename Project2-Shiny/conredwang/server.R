...
shinyServer(function(input, output){
  ...
  output$tabEd_plot1 <- renderPlot({
    ggplot(adult1, 
      ...
      labs(x = "", y = "# education years", title = "[Race=All,Work=All]") + theme_economist() + scale_fill_economist() 
  })
  output$tabEd_plot2 <- renderPlot({
    ...
    ggplot(adult1[adult1$race==input$selectRace & adult1$workclass==input$selectWorkClass,], 
      aes(x=class, y=education_num)) + geom_boxplot() + facet_wrap(~sex) +
      labs(x = "", y = "# education years", title = "[Race=Selected,Work=Selected]") + theme_economist() + scale_fill_economist() 
  })
  output$tabEd_plot3 <- renderPlot({
    ggplot(adult1[adult1$race==input$selectRace,], 
      aes(x=class, y=education_num)) + geom_boxplot() + facet_wrap(~sex) +
      labs(x = "", y = "# education years", title = "[Race=Selected,Work=All]") + theme_economist() + scale_fill_economist() 
  })
  output$tabEd_plot4 <- renderPlot({
    ...
    ggplot(adult1[adult1$workclass==input$selectWorkClass,], 
      aes(x=class, y=education_num)) + geom_boxplot() + facet_wrap(~sex) +
      labs(x = "", y = "# education years", title = "[Race=All,Work=Selected]") + theme_economist() + scale_fill_economist() 
  })
  ...
  output$tabHour_plot1 <- renderPlot({
    ggplot(adult1, 
      ...
      labs(x = "", y = "work hours / week", title = "[Race=All,Work=All]") + theme_economist() + scale_fill_economist() 
  })
  output$tabHour_plot2 <- renderPlot({
   ...
   ggplot(adult1[adult1$race==input$selectRace & adult1$workclass==input$selectWorkClass,], 
      aes(x=class, y=hours_per_week)) + geom_boxplot() + facet_wrap(~sex) +
      labs(x = "", y = "work hours / week", title = "[Race=Selected,Work=Selected]") + theme_economist() + scale_fill_economist() 
  })
  output$tabHour_plot3 <- renderPlot({
    ggplot(adult1[adult1$race==input$selectRace,], 
      aes(x=class, y=hours_per_week)) + geom_boxplot() + facet_wrap(~sex) +
      labs(x = "", y = "work hours / week", title = "[Race=Selected,Work=All]") + theme_economist() + scale_fill_economist() 
  })
  output$tabHour_plot4 <- renderPlot({
    ...
    ggplot(adult1[adult1$workclass==input$selectWorkClass,], 
      aes(x=class, y=hours_per_week)) + geom_boxplot() + facet_wrap(~sex) +
      labs(x = "", y = "work hours / week", title = "[Race=All,Work=Selected]") + theme_economist() + scale_fill_economist() 
  })
  ...
  output$tabMarriage_plot2 <- renderPlot({
    ...
    ggplot(adult1[adult1$race==input$selectRace & adult1$workclass==input$selectWorkClass,], 
      aes(x=marital_status)) + 
      geom_bar(aes(fill=marital_status)) + facet_grid(class ~ sex) +
      xlab("marital status") + theme_economist() + scale_fill_economist() + ggtitle("[Race=Selected,Work=Selected]")
  })
  output$tabMarriage_plot3 <- renderPlot({
    ggplot(adult1[adult1$race==input$selectRace,], 
      aes(x=marital_status)) + 
      geom_bar(aes(fill=marital_status)) + facet_grid(class ~ sex) +
      xlab("marital status") + theme_economist() + scale_fill_economist() + ggtitle("[Race=Selected,Work=All]")
  })
  output$tabMarriage_plot4 <- renderPlot({
    ...
    ggplot(adult1[adult1$workclass==input$selectWorkClass,], 
      aes(x=marital_status)) + 
      geom_bar(aes(fill=marital_status)) + facet_grid(class ~ sex) +
      xlab("marital status") + theme_economist() + scale_fill_economist() + ggtitle("[Race=All,Work=Selected]")
  })
