...
print(paste(sum(!is.na(dataUlt)),"missing values"))
```
### Missing values
As I got toward the end of polishing, I realized I was still missing quite a few data points. I went back through my scrapers and grabbed even more information so I could fill in missing spots. However, that still left many missing values.
### Future Processing
