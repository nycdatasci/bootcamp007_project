...
def run_inference_on_image(num1, num2):
  username = 'instagram'
  dir_name = 'data/' + username + '/'

  #instagram = pd.read_csv(dir_name + username + '_complete.csv')
  temp = pd.DataFrame(columns=['Class 1', 'Class 2', \
                               'Class 3', 'Class 4', \
                               'Class 5', 'score 1','score 2','score 3','score 4','score 5'])
  ...
  for i in range(num1, num2):
    ...
    with tf.Session() as sess:
      ...
      for node_id in top_k:
        ...
        classifications.append(human_string)
        scores.append(score)
