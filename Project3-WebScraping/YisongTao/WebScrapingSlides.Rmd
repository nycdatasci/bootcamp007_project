...
Need to convert anime info in nested list to a data frame first.
...
## Model 1, adjusted R-squared value = 0.289
...
- Normalize viewer numbers against time since its premiere
- add more dummy variables (use number of actor favorites to dummify actors variable, etc.)
