...
def AmzonParser(url):
    ...
    while True:
        ...
        try:
            ...
            XPATH_RANK_IN_CONDOM = '//span[@class="zg_hrsr_rank"][1]//text()'
...
os.chdir('/Users/David/Desktop/NYCDSA/Project/scrapy_draft/Amazon_Main_Page/Amazon_300')
with open('4600_4800.csv', 'rU') as f:
   reader = csv.reader(f)
