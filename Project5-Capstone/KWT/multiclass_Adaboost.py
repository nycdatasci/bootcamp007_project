...
#forest = RandomForestClassifier(n_estimators=50, random_state=1, verbose = 1, criterion='entropy', n_jobs = -1)
adaclf.fit(train_x, train_y)
print "predicting ..."
preds = adaclf.predict_proba(test_x)
...
output_df.to_csv('submit_results_Adaboost.csv', index = False, columns = ['ncodpers', 'added_products'])
