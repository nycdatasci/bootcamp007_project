...
# metacriticScoresVSIncreaseSeventyPlus = filter(metacriticScoresVSIncreaseSeventyPlus, metacriticScoresVSIncreaseSeventyPlus$Review_Score_Metacritic >= 85)
...
#   scale_fill_discrete( h =c(24,350), guide = guide_legend(title = "Game's Age (years)"), labels = labelsYears)
# ggsave(file=paste0(removeSymbols(title), ".eps"))
# # # #END
# #
