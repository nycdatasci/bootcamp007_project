...
`r nrow(indegRanked)` out of `r length(unique(stream$Nickname))` unique users had followers less than 0. `r length(unique(stream$Nickname)) - nrow(indegRanked)` users disregarded.
...
NOTE: Total # of users with retweets less than 0: 10462
...
NOTE: Total # of users with mentions less than 0: 18754
