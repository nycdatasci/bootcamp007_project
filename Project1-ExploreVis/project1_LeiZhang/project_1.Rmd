---
title: "Felling unsafe:Truth or Rumor"
subtitle: "US Crime Analysis"
author: "Lei Zhang"
...
## Hillary Campaign: We are living in the best time!
```{r,echo=FALSE}
...
## Trump Campaign: Truth hiden behind the achievement!
```{r,echo=FALSE}
...
## Trump Campaign: Violent Ratio reach the historical peak!
```{r,echo=FALSE}
...
## Trump Campaign: US,not Trump, become more dangerous to wowen!
```{r,echo=FALSE}
...
## Trump Campaign: We need Law and Order!
```{r,echo=FALSE}
...
## Hillary Campaign: Only Democratic fight against violent crime!
```{r,echo=FALSE}
...
## Hillary Campaign: Republican NEVER make US safer!
```{r,echo=FALSE}
...
## Hillary Campaign: Republican not only ruined the security also the economy
```{r,echo=FALSE}
