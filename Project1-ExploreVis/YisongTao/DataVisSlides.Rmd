...
14.16% of 311 calls are noise complaints.
...
## Is Heating issue and noise issue correlated?
```{r fig. 3_2 Is Heating issue and noise issue correlated,cached= T, echo=F, dev='png', fig.path='silde_figures/', warning=F, message=F}
...
heating_map_plot <- tm_shape(heating_map) +
    ...
    tm_borders(alpha = 0.5) +
    tm_style_natural(legend.frame = F, legend.bg.color = NA)
multiplot(heating_map_plot, nyc_noise_map_banging, cols = 2)
```
Heating issues -> banging noise?
