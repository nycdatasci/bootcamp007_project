---
title: "Project 1-- Exploratory Visualization"
...
- Open data collected and released by various administrative institutions can provide insight into the behavior of service users, and, at the same time, help optimize the services users access.

- I focus here on emergency call data from Seattle

- The main questions animating the analysis are:
...
- I draw on two data sets:

    - [A 911 call data set of 1,324,524 observations collected by the Seattle Police Department](https://data.seattle.gov/Public-Safety/Seattle-Police-Department-911-Incident-Response/3k2p-39jp) 
    
    - [A geospatial data set of Seattle neighborhoods](https://data.seattle.gov/dataset/data-seattle-gov-GIS-shapefile-datasets/f7tb-rnup)
...
- For a first overview of caller behavior I asked the following questions, focusing on three characteristics of the calls: type, timing, and location.
...
## Further analysis
- Next, I explore the two-way combination of timing and type of call as well as the three-way combination of timing, type of call and location. Drawing on the previous analysis, I focus on six most frequnt type of calls.
...
```
## Where do the most frequent types of call occur during peak hours?
```r
...
- Based on the availabe data, the analysis above has suggested some locations and times where particular types of incidentss occur more regularly and which where emergency services and other public institutions may want to prioritize when assesing readiness to respond or prevent these incidents.
