<<<<<<< HEAD
---
title: "Visualization of the NYC Restaurant Safety Inspection"
author: "Alex Li"
...
## Objective of this Exploratory Data Analysis
<img src="wcloud.png" alt="Smiley face" height="300" align="right">

- Examine various factors that potentially affect the inspection grade
...
- Data cleaning/modification
    ...
    + Acquisition of the latest inspection data for each restaurant
...
## Inspection Grade vs Cuisine by Ratio
...
# cui_grd_prop2 = fread("cui_grd_prop2.csv", stringsAsFactors=FALSE)
...
## Violation Citations vs Cuisine
...
# vio_cui_dba = fread("vio_cui_dba.csv", stringsAsFactors=FALSE)
...
## Violation Citations vs Cuisine and Boroughs
...
# vio_heatmap = fread("vio_heatmap.csv", stringsAsFactors=FALSE)
...
ggplot(boro_grd, aes(x=score)) + stat_density(aes(color=boro), geom="line", position="identity") + 
  ...
  ylab("Density") + xlab("Violation Score") + ggtitle("Density Curve of Violation Score in Each Borough") + 
...
zip_choropleth(rec_zip, zip_zoom=rec_zip$region, num_colors=5, title="Violation Score based on NYC Zipcode") + 
...
>>>>>>> f3d7905a17e3cf0223feca75f083c660621c16d0
