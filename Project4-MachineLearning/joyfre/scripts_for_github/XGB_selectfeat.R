...
#Use 3-fold Cross-Validation to measure improvements
rdesc = makeResampleDesc("CV", iters = 3L)

### Feature selection routine
#ctrl = makeFeatSelControlSequential(method = "sbs", alpha = 0.01) # sequentially removing features, drop the feature if improvement is <0.01 in models, too slow.
